...
public class Book {
    ...
    public enum BookStatus {
        ...
        /**
         * 根据状态码获取对应的枚举值。
         * <p>Controller 接收前端传来的状态码（Integer）时，
         * 通过此方法转换为枚举类型供 Service 使用。</p>
         *
         * @param code 状态码（1-在库 2-全部借出 3-下架 4-遗失）
         * @return 对应的枚举值
         * @throws IllegalArgumentException 当状态码不匹配时抛出
         */
        public static BookStatus fromCode(Integer code) {
            for (BookStatus s : values()) {
                if (s.code.equals(code)) return s;
            }
            throw new IllegalArgumentException("无效的图书状态码: " + code);
        }
    }
}